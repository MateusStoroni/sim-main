...
public class DrivingData {
	...
	// private double consumption; // Average fuel consumption since last recharge
	// (km/l)
	...
	// private String ignition; // Vehicle ignition status (7 = vehicle off and 8 =
	// vehicle on)
	...
	// private String localizationRegistrationDate;// Registration date
	// (microseconds)
	...
	// private double orientation_valid; // 3D orientation is valid (0 = not valid
	// and 1 = valid)
	...
	// private String check; // Standard tests completed successfully (0 = failure,
	// 1 = success)
	// private double n_dtc; // Number of active DTCs
	// private ArrayList<String> dtc_value; // List of active DTCs in total
	// indicated by n_dtc
	// private String diagnosticRegistrationDate; // Registration date
	// (microseconds)
	...
	// private double b; // Total distance traveled in the trip (since the last
	// vehicle on event) (m)
	...
	// private double m; // Distance traveled in acceleration/deceleration within
	// the defined limit speed
	// range (m)
	...
	// private double r; // Number of prolonged stop events with running engine
	// (greater than 1 minute)
	// private double s; // Total time in prolonged stop with engine running
	// (microseconds)
	...
	// private double f1; // Total fuel consumed in acceleration/deceleration within
	// the defined limit
	// speed range (L)
	...
	public DrivingData(
			...
			double _averageFuelConsumption, int _fuelType, double _fuelPrice, double _co2Emission, double _HCEmission,
			int _personCapacity, int _personNumber) {
		...
		this.fuelConsumption = _fuelConsumption / 1000;
