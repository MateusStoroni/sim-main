...
public class Auto extends Thread {
	...
	protected void atualizaSensores() {
		...
		try {
			...
			if (!this.getSumo().isClosed()) {
				...
				// System.out.println("RoadID: " + (String)
				// this.sumo.do_job_get(Vehicle.getRoadID(this.idAuto)));
				// System.out.println("RouteID: " + (String)
				// this.sumo.do_job_get(Vehicle.getRouteID(this.idAuto)));
				// System.out.println("RouteIndex: " +
				// this.sumo.do_job_get(Vehicle.getRouteIndex(this.idAuto)));
				...
				// this.drivingRepport.get(this.drivingRepport.size() - 1).getAutoID());
				// // System.out.println(
				// // "timestamp = " + this.drivingRepport.get(this.drivingRepport.size() -
				// // 1).getTimeStamp());
				// // System.out.println("X=" +
				// this.drivingRepport.get(this.drivingRepport.size()
				// // - 1).getX_Position() + ", "
				// // + "Y=" + this.drivingRepport.get(this.drivingRepport.size() -
				// // 1).getY_Position());
				// System.out.println("speed = " +
				// this.drivingRepport.get(this.drivingRepport.size() - 1).getSpeed());
				// System.out
				// .println("odometer = " + this.drivingRepport.get(this.drivingRepport.size() -
				// 1).getOdometer());
				// System.out.println("Fuel Consumption = "
				// + this.drivingRepport.get(this.drivingRepport.size() -
				// 1).getFuelConsumption());
				// // System.out.println("Fuel Type = " + this.fuelType);
				// // System.out.println("Fuel Price = " + this.fuelPrice);

				// System.out.println(
				// "CO2 Emission = " + this.drivingRepport.get(this.drivingRepport.size() -
				// 1).getCo2Emission());
	...
	public double getDistanceTraveled() {
		if (this.drivingRepport.size() == 0) {
			return 0.0;
		}
		return this.drivingRepport.get(this.drivingRepport.size() - 1).getOdometer();
	}
}